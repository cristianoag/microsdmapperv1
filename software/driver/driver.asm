...
; Copyright (c) 2023 Cristiano Goncalves (Adapting the code to support the microSD Mapper Wireless)
...
; ==========================================================================
strTitle:
	db	13,"MSX microSD Mapper Nextor Driver v",27,'J'
	BYTE2STR VER_MAIN
	db	'.'
	BYTE2STR VER_SEC
	db	'.'
...
strCopyright:
	...
	db	"(c) 2017 FRS",13,10
	db  "(c) 2023 The Retro Hacker",13,10
	db	"Licenced under CERN OHL v2",13,10
